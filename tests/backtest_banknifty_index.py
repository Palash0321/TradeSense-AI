...
def calculate_drawdown(trades, initial_capital):
    ...
    This is a research-side diagnostic only.
...
print()
print("=" * 100)
print("TRADESENSE-AI — BANK NIFTY INDEX BASELINE BACKTEST")
print("=" * 100)
...
print("No NIFTY/SENSEX filter is being applied.")
...
try:
    ...
    print()
    print("ERROR: BANK NIFTY download failed.")
    print(exc)
    sys.exit(1)
...
print()
print("-" * 100)
print("BANK NIFTY DATA INTEGRITY")
print("-" * 100)
...
print()
print("=" * 100)
print("RUNNING BANK NIFTY DIRECTIONAL BACKTEST")
print("=" * 100)
...
if not trades:
    ...
    print()
    print(
        "The BANK NIFTY baseline produced zero executable trades."
    )

    print(
        "This may indicate an index-specific sizing issue."
    )
...
print()
print("=" * 100)
print("BANK NIFTY BASELINE RESULT")
print("=" * 100)
...
print(
    "PASS: No NIFTY/SENSEX filter was applied."
)

print(
    "PASS: BANK NIFTY result saved separately."
)

print()
print("=" * 100)
print("BANK NIFTY BASELINE COMPLETE")
print("=" * 100)