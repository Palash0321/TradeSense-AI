...
OUTPUT_DIR = BASE_DIR / "data" / "nifty50_model4"
...
FEATURES = NIFTY_FEATURES + RELATIVE_STRENGTH_FEATURES
...
print("=" * 70)
print("NIFTY 50 MODEL 4")
print("NIFTY HISTORY + RELATIVE STRENGTH")
print("=" * 70)
...
for i in range(
    ...
    probability_up = (
        model
        .predict_proba(X_test_scaled)[0, 1]
    )
...
yearly_file = (
    OUTPUT_DIR
    / "model4_yearly_results.csv"
)

confusion_file = (
    OUTPUT_DIR
    / "model4_confusion_matrix.csv"
)
